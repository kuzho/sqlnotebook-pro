...
- **React 19 & Dependency Modernization:** Upgraded React mounting logic to `createRoot` for React 19 compatibility across webviews and the interactive table renderer.
...
- **Graph RAG (Relational Context):** Built a highly optimized contextual engine for the AI. Instead of sending the entire massive database schema, it uses a Lexical and Relational Graph approach to automatically inject only the tables you mention _plus_ their 1st-degree Foreign Key dependencies.
