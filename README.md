...
<br>
<img src="media/demo-form.png" width="100%" alt="New Connection Form with Test Button">
...
3.  **Run Queries:** Click the **Play** button on each cell (blocks are separated by empty lines).
4.  **Use Autocomplete:**
